...
static void test_sctp_ipv6_packet_to_string(void)
{
	...
	u8 data[] = {
		/* IPv6 Base Header: */
		0x60, 0x00, 0x00, 0x00, 0x00, 0x00, 0x84, 0xff,
	...
	const u16 ipv6_base_header_length = 40u;
	u16 payload_length = sizeof(data) - ipv6_base_header_length;
	/* set the payload length in the ipv6 base header...*/
	data[4] = (payload_length & 0xff00) >> 8;
	data[5] = (payload_length & 0x00ff);
